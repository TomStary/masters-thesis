\newglossaryentry{nosql}{name={NoSQL},description={NoSQL is a term for a database that does not use a relational model to store data. \cite{mongodb_what_nodate}}}
