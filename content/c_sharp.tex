...
Microsoft is developing and maintaining the C\# language. At the time of writing this thesis, the current version of the C\# is C\#10.
...
Visual Basic, and it is also developed by Microsoft.
...
This is either a standalone \acrfull{cli} tool or embedded inside an \acrshort{ide},
